...
Thanks for using dpdeploy! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/amashadihossein/dpdeploy/issues/new).
...
requests](https://github.com/amashadihossein/dpdeploy/issues) to make
