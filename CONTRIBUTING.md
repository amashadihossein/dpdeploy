...
This outlines how to propose a change to dpdeploy. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("amashadihossein/dpdeploy", fork = TRUE)`.
...
Please note that the dpdeploy project is released with a [Contributor
Code of
Conduct](https://amashadihossein.github.io/dpdeploy/CODE_OF_CONDUCT.md).
